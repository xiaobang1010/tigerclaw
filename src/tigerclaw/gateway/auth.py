...
from tigerclaw.gateway.net import (
    get_client_ip_from_request,
    is_local_direct_request,
    is_trusted_proxy_address,
)
from tigerclaw.gateway.rate_limit import (
    AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET,
    AuthRateLimiter,
    RateLimitCheckResult,
)
from tigerclaw.security.secret_equal import safe_equal_secret
...
def is_tailscale_proxy_request(headers: dict[str, Any], remote_addr: str | None) -> bool:
    ...
    """
    from tigerclaw.gateway.net import is_loopback_address
